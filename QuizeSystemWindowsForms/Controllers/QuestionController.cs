...
namespace QuizeSystemWindowsForms.Controllers
{
    class QuestionController
    {
        ...
        public DataTable LoadQuestionTable()
        {
            ...
            try
            {
                ...
                SqlDataAdapter adapter = new SqlDataAdapter("select * from question_view", dbConnection.connection);
        ...
        public bool AddSimpleQuestion(QuestionModel question)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@topic_id", question.Topic.Id);
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        question.Topic.Id = reader.GetInt32(5);
                    }
                }
                reader.Close();
            }
